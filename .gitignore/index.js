...
const TOKEN = "NDU5NzY1ODUyNTMxODUxMjY0.Dh4aXw.2DDq-_e3eiHlQyjXXy-bNp19HRA";
const PREFIX = "-";
...
bot.on("message", message => {
  if (message.content == "test") {
        message.reply(`Bot ${bot.user.username} yenilendi artık calışıyor!`);
  }
});
